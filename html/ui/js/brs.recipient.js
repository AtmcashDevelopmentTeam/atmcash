...
var BRS = (function(BRS, $, undefined) {
    ...
    BRS.sendMoneyCalculateTotal = function(element) {
        ...
        $(element).closest(".modal").find(".total_amount_ordinary").html(BRS.formatAmount(BRS.convertToNQT(amount + fee)) + " ATM");
    };
            ...
            if (response.publicKey) {
                callback({
                    ...
                    "message": $.t("recipient_info", {
                        "atm": BRS.formatAmount(response.unconfirmedBalanceNQT, false, true)
                    }),
                    "account": response
                });
            } else {
