...
var BRS = (function(BRS, $, undefined) {
	...
	if (BRS.accountInfo.errorCode && BRS.accountInfo.errorCode != 5) {
		...
		$("#account_balance_balance").html(BRS.formatAmount(new BigInteger(BRS.accountInfo.balanceNQT)) + " ATM");
		$("#account_balance_unconfirmed_balance").html(BRS.formatAmount(new BigInteger(BRS.accountInfo.unconfirmedBalanceNQT)) + " ATM");
		$("#account_balance_effective_balance").html(BRS.formatAmount(BRS.accountInfo.effectiveBalanceATM) + " ATM");
		$("#account_balance_guaranteed_balance").html(BRS.formatAmount(new BigInteger(BRS.accountInfo.guaranteedBalanceNQT)) + " ATM");
