...
public class ParameterServiceImplTest {
  ...
  @Test
  public void getAccount() throws AtmException {
  ...
  public void getAccount_MissingAccountWhenNoAccountParameterGiven() throws AtmException {
    final HttpServletRequest req = QuickMocker.httpServletRequest();
    t.getAccount(req);
  }

  @Test(expected = ParameterException.class)
  public void getAccount_UnknownAccountWhenIdNotFound() throws AtmException {
    final String accountId = "123";
    final HttpServletRequest req = QuickMocker.httpServletRequest(new MockParam(ACCOUNT_PARAMETER, accountId));
  ...
  @Test(expected = ParameterException.class)
  public void getAccount_IncorrectAccountWhenRuntimeExceptionOccurs() throws AtmException {
    final String accountId = "123";
    final HttpServletRequest req = QuickMocker.httpServletRequest(new MockParam(ACCOUNT_PARAMETER, accountId));
  ...
  public void parseTransaction_transactionJSON_validationExceptionOccurs() throws ParameterException, ValidationException {
    when(transactionProcessorMock.parseTransaction(any(JsonObject.class))).thenThrow(new AtmException.NotValidException(""));
