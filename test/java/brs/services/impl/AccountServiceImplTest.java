...
public class AccountServiceImplTest {
  ...
  public void getAccount() {
    ...
    final AtmKey mockKey = mock(AtmKey.class);
    final Account mockResultAccount = mock(Account.class);

    when(accountAtmKeyFactoryMock.newKey(eq(mockId))).thenReturn(mockKey);
  ...
  public void getAccount_withHeight() {
    ...
    when(accountAtmKeyFactoryMock.newKey(eq(id))).thenReturn(mockKey);
  ...
  public void getAccount_withPublicKey() {
    ...
    when(accountAtmKeyFactoryMock.newKey(anyLong())).thenReturn(mockKey);
  ...
  public void getOrAddAccount_addAccount() {
    ...
    when(accountAtmKeyFactoryMock.newKey(eq(accountId))).thenReturn(mockKey);
