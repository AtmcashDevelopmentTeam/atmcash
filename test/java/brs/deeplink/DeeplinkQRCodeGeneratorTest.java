...
public class DeeplinkQRCodeGeneratorTest {
    ...
    public void testDeeplinkQrCodeGenerator() throws WriterException {
        BufferedImage image = deeplinkQRCodeGenerator.generateRequestAtmDeepLinkQRCode(TestConstants.TEST_ACCOUNT_NUMERIC_ID, TestConstants.TEN_ATM, FeeSuggestionType.STANDARD, 0L, "Test!", true);
        assertNotNull(image);
    }
}
