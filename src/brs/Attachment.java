...
public interface Attachment extends Appendix {
  ...
  abstract class AbstractAttachment extends AbstractAppendix implements Attachment {
    ...
    @Override
    public final void validate(Transaction transaction) throws AtmException.ValidationException {
    ...
    public static AbstractAttachment parseProtobufMessage(Any attachment) throws InvalidProtocolBufferException, AtmException.NotValidException {
      ...
      if (attachment.is(BrsApi.OrdinaryPaymentAttachment.class)) {
        ...
        return new AtmMiningRewardRecipientAssignment(attachment.unpack(BrsApi.RewardRecipientAssignmentAttachment.class));
  ...
  class PaymentMultiOutCreation extends AbstractAttachment {
    ...
    PaymentMultiOutCreation(ByteBuffer buffer, byte transactionVersion) throws AtmException.NotValidException {
      super(buffer, transactionVersion);
      ...
      for (int i = 0; i < numberOfRecipients; ++i) {
        ...
        if (recipientOf.containsKey(recipientId))
          throw new AtmException.NotValidException("Duplicate recipient on multi out transaction");

        if (amountNQT <= 0)
          throw new AtmException.NotValidException("Insufficient amountNQT on multi out transaction");
      ...
      if (recipients.size() > Constants.MAX_MULTI_OUT_RECIPIENTS || recipients.size() <= 1) {
        throw new AtmException.NotValidException(
            "Invalid number of recipients listed on multi out transaction");
      }
    }

    PaymentMultiOutCreation(JsonObject attachmentData) throws AtmException.NotValidException {
      super(attachmentData);
      ...
      if (receipientsJson.size() > Constants.MAX_MULTI_OUT_RECIPIENTS || receipientsJson.size() <= 1) {
        throw new AtmException.NotValidException("Invalid number of recipients listed on multi out transaction");
      }
    }

    public PaymentMultiOutCreation(Collection<Entry<String, Long>> recipients, int blockchainHeight) throws AtmException.NotValidException {
      super(blockchainHeight);
    ...
    PaymentMultiOutCreation(BrsApi.MultiOutAttachment attachment) throws AtmException.NotValidException {
  ...
  class PaymentMultiSameOutCreation extends AbstractAttachment {
    ...
    PaymentMultiSameOutCreation(ByteBuffer buffer, byte transactionVersion) throws AtmException.NotValidException {
      super(buffer, transactionVersion);
      ...
      for (int i = 0; i < numberOfRecipients; ++i) {
        ...
        if (recipientOf.containsKey(recipientId))
          throw new AtmException.NotValidException("Duplicate recipient on multi same out transaction");
    ...
    PaymentMultiSameOutCreation(JsonObject attachmentData) throws AtmException.NotValidException {
      super(attachmentData);
    ...
    public PaymentMultiSameOutCreation(Collection<Long> recipients, int blockchainHeight) throws AtmException.NotValidException {
      super(blockchainHeight);
    ...
    PaymentMultiSameOutCreation(BrsApi.MultiOutSameAttachment attachment) throws AtmException.NotValidException {
      super(((byte) attachment.getVersion()));
      HashMap<Long,Boolean> recipientOf = new HashMap<>();
  ...
  class MessagingAliasAssignment extends AbstractAttachment {
    ...
    MessagingAliasAssignment(ByteBuffer buffer, byte transactionVersion) throws AtmException.NotValidException {
      super(buffer, transactionVersion);
  ...
  class MessagingAliasSell extends AbstractAttachment {
    ...
    MessagingAliasSell(ByteBuffer buffer, byte transactionVersion) throws AtmException.NotValidException {
      super(buffer, transactionVersion);
  ...
  final class MessagingAliasBuy extends AbstractAttachment {
    ...
    MessagingAliasBuy(ByteBuffer buffer, byte transactionVersion) throws AtmException.NotValidException {
      super(buffer, transactionVersion);
      this.aliasName = Convert.readString(buffer, buffer.get(), Constants.MAX_ALIAS_LENGTH);
    }
  ...
  final class MessagingAccountInfo extends AbstractAttachment {
    ...
    MessagingAccountInfo(ByteBuffer buffer, byte transactionVersion) throws AtmException.NotValidException {
      super(buffer, transactionVersion);
  ...
  class ColoredCoinsAssetIssuance extends AbstractAttachment {
    ...
    ColoredCoinsAssetIssuance(ByteBuffer buffer, byte transactionVersion) throws AtmException.NotValidException {
      super(buffer, transactionVersion);
  ...
  final class ColoredCoinsAssetTransfer extends AbstractAttachment {
    ...
    ColoredCoinsAssetTransfer(ByteBuffer buffer, byte transactionVersion) throws AtmException.NotValidException {
      super(buffer, transactionVersion);
  ...
  final class DigitalGoodsListing extends AbstractAttachment {
    ...
    DigitalGoodsListing(ByteBuffer buffer, byte transactionVersion) throws AtmException.NotValidException {
      super(buffer, transactionVersion);
  ...
  final class DigitalGoodsDelivery extends AbstractAttachment {
    ...
    DigitalGoodsDelivery(ByteBuffer buffer, byte transactionVersion) throws AtmException.NotValidException {
      super(buffer, transactionVersion);
  ...
  final class AtmMiningRewardRecipientAssignment extends AbstractAttachment {
    ...
    public AtmMiningRewardRecipientAssignment(int blockchainHeight) {
      super(blockchainHeight);
    }

    AtmMiningRewardRecipientAssignment(BrsApi.RewardRecipientAssignmentAttachment attachment) {
      super((byte) attachment.getVersion());
    }
  ...
  final class AdvancedPaymentEscrowCreation extends AbstractAttachment {
    ...
    AdvancedPaymentEscrowCreation(ByteBuffer buffer, byte transactionVersion) throws AtmException.NotValidException {
      super(buffer, transactionVersion);
      ...
      if(totalSigners > 10 || totalSigners <= 0) {
        throw new AtmException.NotValidException("Invalid number of signers listed on create escrow transaction");
      }
      for(int i = 0; i < totalSigners; i++) {
        if(!this.signers.add(buffer.getLong())) {
          throw new AtmException.NotValidException("Duplicate signer on escrow creation");
        }
      }
    }

    AdvancedPaymentEscrowCreation(JsonObject attachmentData) throws AtmException.NotValidException {
      super(attachmentData);
    ...
    public AdvancedPaymentEscrowCreation(Long amountNQT, int deadline, Escrow.DecisionType deadlineAction,
                                         int requiredSigners, Collection<Long> signers, int blockchainHeight) throws AtmException.NotValidException {
      super(blockchainHeight);
    ...
    AdvancedPaymentEscrowCreation(BrsApi.EscrowCreationAttachment attachment) throws AtmException.NotValidException {
      super((byte) attachment.getVersion());
  ...
  final class AutomatedTransactionsCreation extends AbstractAttachment{
    ...
    AutomatedTransactionsCreation(ByteBuffer buffer,
                                  byte transactionVersion) throws AtmException.NotValidException {
      super(buffer, transactionVersion);
      ...
      int pageSize = ( int ) AtConstants.getInstance().pageSize( Atm.getBlockchain().getHeight() );
