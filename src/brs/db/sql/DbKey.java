...
public interface DbKey extends AtmKey {

  abstract class Factory<T> implements AtmKey.Factory<T> {
  ...
  abstract class LongKeyFactory<T> extends Factory<T> implements AtmKey.LongKeyFactory<T> {
  ...
  abstract class LinkKeyFactory<T> extends Factory<T> implements AtmKey.LinkKeyFactory<T> {
