...
public class SqlAssetTransferStore implements AssetTransferStore {
  ...
  private static final AtmKey.LongKeyFactory<AssetTransfer> transferDbKeyFactory = new DbKey.LongKeyFactory<AssetTransfer>(ASSET_TRANSFER.ID) {

      @Override
      public AtmKey newKey(AssetTransfer assetTransfer) {
  ...
  @Override
  public AtmKey.LongKeyFactory<AssetTransfer> getTransferDbKeyFactory() {
