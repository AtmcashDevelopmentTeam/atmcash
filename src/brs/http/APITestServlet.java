...
public class APITestServlet extends HttpServlet {
  ...
  private static final String HEADER_1 =
      ...
      + "            })\n"
      + "            .fail(function() {\n"
      + "                alert('API not available, check if Atm Server is running!');\n"
      + "            });\n"
      ...
      + "           <a class=\"navbar-brand\" href=\"/test\">Atm http API</a>"
      + "       </div>"
      + "       <div class=\"navbar-collapse collapse\">"
      + "           <ul class=\"nav navbar-nav navbar-right\">"
      + "               <li><input type=\"text\" class=\"form-control\" id=\"search\" "
      + "                    placeholder=\"Search\" style=\"margin-top:8px;\"></li>\n"
      + "               <li><a href=\"https://atmwiki.org/en/the-atm-api/\" target=\"_blank\" style=\"margin-left:20px;\">Wiki Docs</a></li>"
