...
public class APITransactionManagerImpl implements APITransactionManager {
  ...
  @Override
  public JsonElement createTransaction(HttpServletRequest req, Account senderAccount, Long recipientId, long amountNQT, Attachment attachment, long minimumFeeNQT) throws AtmException {
    ...
    if (messageValue != null) {
      boolean messageIsText = Atm.getFluxCapacitor().getValue(FluxValues.DIGITAL_GOODS_STORE, blockchainHeight)
    ...
    } else if (attachment instanceof Attachment.ColoredCoinsAssetTransfer && Atm.getFluxCapacitor().getValue(FluxValues.DIGITAL_GOODS_STORE, blockchainHeight)) {
    ...
    } else if (attachment == Attachment.ARBITRARY_MESSAGE && ! Atm.getFluxCapacitor().getValue(FluxValues.DIGITAL_GOODS_STORE, blockchainHeight)) {
    ...
    if (recipientPublicKey != null && Atm.getFluxCapacitor().getValue(FluxValues.DIGITAL_GOODS_STORE, blockchainHeight)) {
    ...
    } catch (AtmException.NotYetEnabledException e) {
