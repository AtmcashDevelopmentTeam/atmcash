...
public class AtmGUI extends Application {
    private static final String ICON_LOCATION = "/images/atm_overlay_logo.png";
    private static final String FAILED_TO_START_MESSAGE = "AtmGUI caught exception starting BRS";
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(AtmGUI.class);
    ...
    public void start(Stage primaryStage) {
        System.setSecurityManager(new AtmGUISecurityManager());
        primaryStage.setTitle("Atm Reference Software version " + Atm.VERSION);
    ...
    private TrayIcon createTrayIcon() {
        try {
            ...
            TrayIcon newTrayIcon = new TrayIcon(Toolkit.getDefaultToolkit().createImage(AtmGUI.class.getResource(ICON_LOCATION)), "Atm Reference Software", popupMenu);
    ...
    private void openWebUi() {
        try {
            PropertyService propertyService = Atm.getPropertyService();
    ...
    private class AtmGUISecurityManager extends SecurityManager {
