...
public final class Atm {
  ...
  private static PropertyService loadProperties() {
    ...
    logger.info("Initializing Atm Reference Software (BRS) version {}", VERSION);
  ...
  public static void main(String[] args) {
    Runtime.getRuntime().addShutdownHook(new Thread(Atm::shutdown));
    init();
  }
  ...
  private static void loadWallet(PropertyService propertyService) {
    ...
    Atm.propertyService = propertyService;
    ...
    (new Thread(Atm::commandHandler)).start();
  }
