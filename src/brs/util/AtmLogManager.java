...
/**
 * Java LogManager extension for use with Atm
 */
class AtmLogManager extends LogManager {
   ...
   * done terminating the Atm processes.
   */
  public AtmLogManager() {
    super();
  }
   ...
   * This allows us to continue to use logging facilities during Atm shutdown.
   */
  @Override
  public void reset() {
  ...
  /**
   * Atm shutdown is now complete, so call LogManager.reset() to terminate
   * the log handlers.
   */
  void atmShutdown() {
    super.reset();
