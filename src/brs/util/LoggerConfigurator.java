...
/**
 * Handle logging for the Atm node server
 */
...
public final class LoggerConfigurator {
  ...
  public static void init() {
    ...
    System.setProperty(managerPackage, "brs.util.AtmLogManager");
    if (!(LogManager.getLogManager() instanceof AtmLogManager)) {
  ...
  public static void shutdown() {
    if (LogManager.getLogManager() instanceof AtmLogManager) {
      ((AtmLogManager) LogManager.getLogManager()).atmShutdown();
    }
  }
}
