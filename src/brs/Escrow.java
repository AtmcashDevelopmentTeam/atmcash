...
public class Escrow {
  ...
  public static class Decision {
    ...
    public Decision(AtmKey dbKey, Long escrowId, Long accountId, DecisionType decisionType) {
      this.dbKey = dbKey;
  ...
  public Escrow(AtmKey dbKey, Account sender,
      Account recipient,
      Long id,
      Long amountNQT,
      int requiredSigners,
  ...
  protected Escrow(Long id, Long senderId, Long recipientId, AtmKey dbKey, Long amountNQT,
  ...
  public Collection<Decision> getDecisions() {
    return Atm.getStores().getEscrowStore().getDecisions(id);
  }
