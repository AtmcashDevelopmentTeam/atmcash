...
public class Props {
  ...
  // DB options
  public static final Prop<String> DB_URL          = new Prop<>("DB.Url", "jdbc:mariadb://localhost:3306/atmwallet");
  ...
  public static final Prop<Integer> P2P_PORT        = new Prop<>("P2P.Port", 8111);
